...
**PR 미리보기(preview) 배포**는 fork PR의 경우 관리자 Vercel 승인이 있어야 생성돼 자동으로 뜨지 않는다.
그래서 화면이 바뀌는 PR은 본문에 **as-is/to-be 스크린샷 2장**을 첨부한다(상세 → [CONTRIBUTING.md](./CONTRIBUTING.md) §4).
